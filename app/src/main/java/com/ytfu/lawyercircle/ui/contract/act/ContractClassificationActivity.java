package com.ytfu.lawyercircle.ui.contract.act;
...
import com.ytfu.lawyercircle.helper.ScaleTransitionPagerTitleView;
import com.ytfu.lawyercircle.ui.contract.fragment.ContractClassificationFragment;
...
/** @Auther gxy @Date 2020/7/30 @Des 合同分类 */
@InjectLayout(
        value = R.layout.activity_contract_classication,
...
public class ContractClassificationActivity extends BaseActivity {
    ...
    private void setData() {
        HttpUtil.getInstance()
                ...
                .subscribe(
                        new BaseRxObserver<ContractListFirstBean>() {
                            @Override
        ...
        viewPage.setAdapter(
                new FragmentStatePagerAdapter(getSupportFragmentManager()) {
                    ...
                    public Fragment getItem(int position) {
                        return ContractClassificationFragment.newInstance(
                                entity.getList().get(position).getId());
                    }
