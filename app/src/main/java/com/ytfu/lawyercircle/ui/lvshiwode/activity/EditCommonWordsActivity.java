...
import com.ytfu.lawyercircle.ui.lvshiwode.presenter.EditCommonWordsPresenter;
...
/** @Auther gxy @Date 2020/7/14 @Des 编辑常用语 */
@InjectLayout(
...
public class EditCommonWordsActivity
        extends BaseActivity<EditCommonWordsView, EditCommonWordsPresenter>
        implements EditCommonWordsView {
    ...
    public static void startActivityForresult(
            Fragment fragment, int requestCode, String ReplyID, String content) {
        Bundle bundle = new Bundle();
        bundle.putString(KEY_REPLY_ID, ReplyID);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (null != item) {
            ...
            // 设置文字颜色。
            ssb.setSpan(
                    new ForegroundColorSpan(getResources().getColor(R.color.textColor_33)),
                    0,
                    title.length(),
