...
import com.ytfu.lawyercircle.ui.users.p.ConsultationDetailsRewardPresenter2;
...
/** @Auther gxy @Date 2020/7/6 @Des 他的咨询详情 */
@InjectLayout(
        value = R.layout.activity_consultation_details2,
        toolbarLayoutId = R.layout.layout_toolbar_center_title)
@InjectPresenter(ConsultationDetailsRewardPresenter2.class)
public class ConsultationDetailsActivity2
        extends BaseActivity<ConsultationDetailsView2, ConsultationDetailsRewardPresenter2>
    ...
    protected void initData() {
        ...
        //                .replace(R.id.fl_consultation_count,
        // ConsultationDetailsRewardFragment2.newInstance(getBundleString(KEY_CONSULTATION_ID, "")))
        ...
        // 立即沟通
        tv_communicate_now.setOnClickListener(
                v -> {
